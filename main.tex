...
\begin{figure}
    ...
    \subfloat[ With Outage RMS Error = 3.8 ]{\includegraphics[width=.5\textwidth]{images/outage_location.png}}
    \subfloat[ Without Outage RMS Error = 3.2]{\includegraphics[width=.5\textwidth]{images/no_outage_location.png}}
