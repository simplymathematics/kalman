...
\begin{figure}
    ...
    \subfloat[ With Outage RMS Error = 1.86 ]{\includegraphics[width=.5\textwidth]{images/outage_location.png}}
    \subfloat[ Without Outage RMS Error = 1.16]{\includegraphics[width=.5\textwidth]{images/no_outage_location.png}}
...
\begin{figure}
    ...
    \subfloat[ With Outage]{\includegraphics[width=.5\textwidth]{images/outage_difference.png}}
    \subfloat[ Without Outage]{\includegraphics[width=.5\textwidth]{images/no_outage_difference.png}}
...
\begin{frame}{Task4}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{images/error_growth.png}
        \caption{Caption}
        \label{fig:my_label}
    \end{figure}
\end{frame}
...
% \end{frame}
\end{document}
%  without outage: positionerr_RMS = 1.8606