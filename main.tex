...
\begin{figure}
    ...
    \subfloat[ Without Outage RMS Error = 1.56]{\includegraphics[width=.5\textwidth]{images/no_outage_location.png}}
...
\begin{figure}
    ...
    \subfloat[ With Outage RMS Error = 1.65]{\includegraphics[width=.5\textwidth]{images/outage_difference.png}}
    \subfloat[ Without Outage RMS Error = 1.56]{\includegraphics[width=.5\textwidth]{images/no_outage_difference.png}}
